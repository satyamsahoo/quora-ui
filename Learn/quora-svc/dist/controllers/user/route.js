...
middlewares_1.validationHandler(), controllerAdapter_1.default(UserController_1.default, 'list'));
/**
 * @swagger
 * /homes/{id}:
 *   get:
...
middlewares_1.validationHandler(), controllerAdapter_1.default(UserController_1.default, 'get'));
/**
 * @swagger
 * /homes:
 *   post:
...
middlewares_1.validationHandler(), controllerAdapter_1.default(UserController_1.default, 'create'));
/**
 * @swagger
 * /homes:
 *   put:
...
middlewares_1.validationHandler(), UserController_1.default.update);
/**
 * @swagger
 * /homes/{id}:
 *   delete:
...
middlewares_1.validationHandler(), UserController_1.default.delete);
